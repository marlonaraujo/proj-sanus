 ...
 * @author emilianoeloi
 */
public class ConexaoFactoryBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( factory.ConexaoFactory.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor

        // Here you can add code for customizing the BeanDescriptor.

        return beanDescriptor;     }//GEN-LAST:BeanDescriptor
    // Property identifiers//GEN-FIRST:Properties
    private static final int PROPERTY_conexao = 0;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_conexao] = new PropertyDescriptor ( "conexao", factory.ConexaoFactory.class, "getConexao", null ); // NOI18N
        }
    ...
    private static final int METHOD_getInstancia0 = 0;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_getInstancia0] = new MethodDescriptor(factory.ConexaoFactory.class.getMethod("getInstancia", new Class[] {})); // NOI18N
            methods[METHOD_getInstancia0].setDisplayName ( "" );
        }
